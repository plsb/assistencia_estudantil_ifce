...
public class CampusTableModel extends AbstractTableModel {
     ...
     */
    public CampusTableModel(List<Campus> list) {
        campi = new ArrayList(new HashSet(list));
        this.campi.clear();
        Collections.sort(list);
        this.campi.addAll(list);
    ...
    public Campus getCampus(int rowIndex) {
        return campi.get(rowIndex);
    }
    /**
     * Método sobrescrito.
     *
