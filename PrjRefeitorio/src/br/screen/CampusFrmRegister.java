 ...
 * @author pelusb
 */
public class CampusFrmRegister extends javax.swing.JDialog {
    ...
    public CampusFrmRegister(Campus campus) {
        initComponents();
        setLocationRelativeTo(null);
        setModal(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        campus.setDescription(tfDesc.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CampusFrmRegister.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CampusFrmRegister().setVisible(true);
            }
        });
    }
