 ...
 * @author João
 */
public class UserFrmFind extends javax.swing.JDialog {
    ...
    public void preencheTabela(String texto) {
        ...
        if (texto.equals("")) {
            UserTableModel ptm = new UserTableModel(uDAO.list());
            tbUser.setModel(ptm);
        } else {
            UserTableModel ptm = new UserTableModel(uDAO.checkExistsLike("login", texto));
            tbUser.setModel(ptm);
        }

        FormatSizeColJTable.packColumns(tbUser, 1);
    }
    ...
    private void initComponents() {
        ...
        jLabel23.setText("Consulta de Usuários");
        ...
        tbUser.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        ...
        tbUser.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                tbUserMouseEntered(evt);
            }
        });
        jScrollPane1.setViewportView(tbUser);

        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 80, 680, 220));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 300, 57, 40));
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 300, -1, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 300, -1, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 300, -1, -1));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 30, 700, 350));
    ...
    private void tbUserMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbUserMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_tbUserMouseEntered
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (tbUser.getSelectedRow() < 0) {
            ...
            UserTableModel ptm = (UserTableModel) tbUser.getModel();
            User select = ptm.getUser(tbUser.getSelectedRow());
            if (JOptionPane.showConfirmDialog(rootPane, "Deseja Excluir o Usuário " + select.getName() + "?",
                ...
                try {
                    uDAO.remove(select);
                      ...
                      JOptionPane.showMessageDialog(rootPane, "Usuário não pode ser excluído!");
                }
                preencheTabela(tfPesquisarNome.getText().toString());
            }
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        UserFrmRegister rpf = new UserFrmRegister();
        rpf.setVisible(true);
        preencheTabela(tfPesquisarNome.getText().toString());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
       if (tbUser.getSelectedRow() < 0) {
            ...
            UserTableModel ptm = (UserTableModel) tbUser.getModel();
            User select = ptm.getUser(tbUser.getSelectedRow());
            UserFrmRegister rpf = new UserFrmRegister(select);
            rpf.setVisible(true);
            preencheTabela(tfPesquisarNome.getText().toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UserFrmFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UserFrmFind().setVisible(true);
            }
        });
    }
