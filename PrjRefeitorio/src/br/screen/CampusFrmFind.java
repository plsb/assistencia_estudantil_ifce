...
import br.campus.CampusTableModel;
 ...
 * @author João
 */
public class CampusFrmFind extends javax.swing.JDialog {

    /**
     * Creates new form FindPersonFrm
     */
    public CampusFrmFind() {
        initComponents();
        setModal(true);
    ...
    public void preencheTabela(String texto) {
        CampusDAO sDAO = new CampusDAO();
        if (texto.equals("")) {
            CampusTableModel ptm = new CampusTableModel(new ArrayList(new HashSet(sDAO.list())));
            tbCampus.setModel(ptm);
        } else {
            CampusTableModel ptm = 
                    new CampusTableModel(
                            new ArrayList(new HashSet(sDAO.checkExistsLike("description", texto))));
            tbCampus.setModel(ptm);
        }

        FormatSizeColJTable.packColumns(tbCampus, 1);
    }
    ...
    private void initComponents() {
        ...
        tbCampus = new javax.swing.JTable();
        ...
        jLabel23.setText("Consulta de Campus");
        ...
        tbCampus.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        tbCampus.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {null, null, null, null},
                {null, null, null, null},
                {null, null, null, null},
        ...
        tbCampus.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tbCampusMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                tbCampusMouseEntered(evt);
            }
        });
        jScrollPane1.setViewportView(tbCampus);
        ...
        jPanel1.add(btnDelete, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 300, -1, -1));
        ...
        jPanel1.add(btnNew, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 300, -1, -1));
        ...
        jPanel1.add(btnEdit, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 300, -1, -1));
    ...
    private void tbCampusMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCampusMouseClicked
        if(evt.getClickCount() == 2){
            btnEditActionPerformed(null);
        }


    }//GEN-LAST:event_tbCampusMouseClicked

    private void tbCampusMouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbCampusMouseEntered
        // TODO add your handling code here:
    }//GEN-LAST:event_tbCampusMouseEntered
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        if (tbCampus.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(rootPane, "Selecione uma linha da tabela!");
        } else {
            CampusTableModel ptm = (CampusTableModel) tbCampus.getModel();
            Campus select = ptm.getCampus(tbCampus.getSelectedRow());
            if (JOptionPane.showConfirmDialog(rootPane, "Deseja Excluir o Campus " + select.getDescription() + "?",
                    "Excluir Campus", JOptionPane.YES_NO_OPTION)
                    == JOptionPane.YES_OPTION) {
                CampusDAO cDAO = new CampusDAO();
                try {
                    cDAO.remove(select);
                } catch (Exception ex) {
                      JOptionPane.showMessageDialog(rootPane, "Campus não pode ser excluído!");
                }
                preencheTabela(tfPesquisarNome.getText().toString());
            }
    ...
    private void btnNewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewActionPerformed
        CampusFrmRegister rpf = new CampusFrmRegister();
        rpf.setVisible(true);
        preencheTabela(tfPesquisarNome.getText().toString());
    ...
    private void btnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditActionPerformed
       if (tbCampus.getSelectedRow() < 0) {
            ...
            CampusTableModel ptm = (CampusTableModel) tbCampus.getModel();
            Campus select = ptm.getCampus(tbCampus.getSelectedRow());
            CampusFrmRegister rpf = new CampusFrmRegister(select);
            rpf.setVisible(true);
            preencheTabela(tfPesquisarNome.getText().toString());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CampusFrmFind.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CampusFrmFind().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tbCampus;
